...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //セル内のcomentsボタンのアクションをソースコードで設定する
        cell.comentsButton.addTarget(self, action:#selector(handleComentsButton(_:forEvent:)), for: .touchUpInside)
    ...
    @objc func handleComentsButton(_ sender: UIButton, forEvent event: UIEvent) {
        print("DEBUG_PRINT: comentsボタンがタップされました")
